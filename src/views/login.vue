  ...
  <div class="loginbox">
      <!-- 太极 -->
        <div class="box">
          ...
          <div class="circlebm"></div>
          <div class="circlewm"></div>
...
export default {
  ...
  methods: {
    login(){
      this.$router.replace({name:'Login_reg'})
    }
  },
}
</script>
...
.box {
  ...
  margin: 0 auto;
  position: relative;
  animation: infinite linear taiji 5s;
  margin-top: 50px;
  margin-bottom: 220px;
...
.el-button.is-round:nth-of-type(1){
  color: #ffffff;
}
.icon{
  display: flex;
...
.icon i:nth-of-type(2){
  color: greenyellow;
}
.icon i:nth-of-type(3){
  color: red;
}
.icon i:nth-of-type(4){
  color: orangered;
}
</style>
